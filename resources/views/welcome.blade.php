                    ...
                    <div class="slider-content">
                        <div class="container">
                            <div class="slider-text text-center">
                                <h3 class="slide-title"><span>Ultimate</span> FX <span>Trading</span><br/> Platform</h3>
                ...
                <div class="item bg-parallax item-2">
                    <div class="slider-content">
                        <div class="col-md-12">
                            <div class="container">
                                <div class="slider-text text-center">
                                    <h3 class="slide-title"><span>FX Trades</span> Easy Way <br/>To <span>Trade</span> </h3>
                                    <p>24/7 Live Support. Our support channels are available anytime everyday</p>
                                    <p>
                                        <a href="{{url('buy-bitcoin')}}" class="slider btn btn-primary">BUY BITCOIN</a>
                                    </p>
                                </div>
                            </div>
                        </div>
